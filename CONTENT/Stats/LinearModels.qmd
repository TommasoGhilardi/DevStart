...
-   `ReactionTime` we will ignore this variable for now
...
-   `LookingTime ~ Event_trial + Event`. This formulation tells the model to assess whether either `Event_trial` or `Event` predicts `LookingTime`, treating them as independent predictors.
