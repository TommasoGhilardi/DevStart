...
We won’t delve into the details of the model results in this tutorial, as we have already cover it in the previous one. However we want to point out one thing about the data we run it on!!
...
While is not super apparent from the data you can see that different subjects have different slopes meaning that they do not all grow at the same rate
