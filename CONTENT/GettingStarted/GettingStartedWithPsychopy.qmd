...
keywords-meta: "PsychoPy, Python, experimental psychology, tutorial, installation, DevStart, developmental science, Spyder ide, Spyder"
categories:
  - Setup
  - Python
---
...
We have also made a more complete environment, which contains Psychopy as well as Spyder (which is a python IDE) and tobii_research (which allows you to interact with an eye-tracker). You can download here <a href="/resources/psychopy.yml" download>our environment</a> from our github repository.
