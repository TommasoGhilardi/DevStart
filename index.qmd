...
keywords-meta: ["DevStart, developmental cognitive science, PhD, research methods, data analysis,programming, neuroscience, psychology, developmental research, developmental science"]
---
...
<table style="width: 100%; border-collapse: collapse; border: none;">
       <tr>
           <td style="width: 30%; padding: 10px; vertical-align: middle; text-align: center; border: none;">
               <img src="images/welcome/Tommaso.jpg" alt="Tommaso" style="max-width: 100%;">
           </td>
           <td style="width: 70%; padding: 10px; text-align: justify; border: none;">
...
<table style="width: 100%; border-collapse: collapse; border: none;">
       <tr>
           <td style="width: 30%; padding: 10px; vertical-align: middle; text-align: center; border: none;">
               <img src="images/welcome/Francesco.jpeg" alt="Francesco" style="max-width: 100%;">
           </td>
           <td style="width: 70%; padding: 10px; text-align: justify; border: none;">
...
<table style="width: 100%; border-collapse: collapse; border: none;">
       <tr>
           <td style="width: 30%; padding: 10px; vertical-align: middle; text-align: center; border: none;">
               <img src="images/welcome/Giulia.png" alt="Image" style="max-width: 100%;">
           </td>
           <td style="width: 70%; padding: 10px; text-align: justify; border: none;">
...
<div class="card">
  <div class="card-body">
    <a href="https://zenodo.org/doi/10.5281/zenodo.13361295">
      <img src="https://zenodo.org/badge/501816247.svg" alt="DOI" class="card-title">
    </a>
    <h6 class="card-subtitle mb-2 text-muted">Citation Information</h6>
    <p class="card-text">
      If you would like to cite the website, please use the following reference::<br><br>
      
      <i>Ghilardi, T., Poli, F., & Serino, G. (2024). TommasoGhilardi/DevStart: TIE (v1.0.0). Zenodo. <a href="https://doi.org/10.5281/zenodo.13361296">https://doi.org/10.5281/zenodo.13361296</a></i>
    </p>
  </div>
</div>
```
